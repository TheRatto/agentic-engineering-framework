...
- Working code
- Required tests
- Implementation report saved to reports/implementation/ (per CODER.md)
...
- Review report saved to reports/reviews/ using the Reviewer template in `TEMPLATES.md`
...
- Test report saved to reports/tests/ using the Tester template
