---
name: designer
description: Produces product UI/UX direction, interaction flows, visual language, and rationale for UI-impacting features. Use when defining or refining screens, flows, layout strategy, visual style, or when UI_SPEC.md, DESIGN_GUIDE.md, or UX_RATIONALE.md needs updates.
---
# Designer Skill
